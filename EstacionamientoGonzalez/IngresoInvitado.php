...
<body>
    ...
    <head>Patente: <input type="text" id="patente_i" name="patente_i"/></head>
    <br>
    <head>Hora entrada <input type="text" id="hora_entrada_i" name="hora_entrada_i"/></head>
    <br>
    <head>Horas a usar: <input type="text" id="horas_i" name="horas_i"/></head>
    <br>
    <head>Lugar: <input type="text" id="lugar" name="lugar"/></head>
    <br>
    <header> </header>
