...
$hora_entrada_i=$_POST['hora_entrada_i'];
$horas_i=$_POST['horas_i'];
$lugar=$_POST['lugar'];

session_start();
$_SESSION['patente_i']=$patente_i;
$_SESSION['hora_entrada_i']=$hora_entrada_i;
...
insert into invitados (patente_i,hora_entrada_i,horas_i,deuda_i,id_lugar) values ('$patente_i','$hora_entrada_i',$horas_i,($horas_i*120),(select id_lugar from lugares where lugar = '$lugar'));
else
signal SQLSTATE '02000' SET MESSAGE_TEXT = 'LUGAR OCUPADO';
end if;";
$consulta2="insert into visitas (patente_v,hora_entrada,horas_v,fecha_v,id_lugar) values ('$patente_i','$hora_entrada_i',$horas_i,(select current_date()), (select id_lugar from lugares where lugar = '$lugar'));";
